    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="display-5 text-primary m-0">SNFinance</h1>
            </a>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p
                                        ...
                                        Welcome to SNFinance</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Votre situation financière est notre objectif
                                    </h1>
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    ...
                                    <h1 class="display-1 mb-4 animated slideInDown">Un soutien financier fiable pour vous</h1>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInDown">Explore More</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" src="{{asset('img/about.jpg')}}">
                </div>
                <div id="about" class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <p class="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">A propos</p>
                    <h1 class="display-5 mb-4">Nous aidons nos clients à gerer leur finance</h1>
                    ...
                    <div class="tab-content w-100">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="{{asset('img/service-1.jpg')}}"
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="{{asset('img/service-2.jpg')}}"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="{{asset('img/service-3.jpg')}}"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-4">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute rounded w-100 h-100" src="{{asset('img/service-4.jpg')}}"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="project-item pe-5 pb-5">
                    <div class="project-img mb-3">
                        <img class="img-fluid rounded" src="{{asset('img/service-4.jpg')}}" alt="">
                        <a href=""><i class="fa fa-link fa-3x text-primary"></i></a>
                    </div>
                    <div class="project-title">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <img class="img-fluid rounded" src="{{asset('img/team-1.jpg')}}" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <img class="img-fluid rounded" src="{{asset('img/team-2.jpg')}}" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <img class="img-fluid rounded" src="{{asset('img/team-3.jpg')}}" alt="">
                        <div class="team-text">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div class="testimonial-item">
                    ...
                    <img class="rounded-circle mb-3" src="{{asset('img/testimonial-1.jpg')}}" alt="">
                    <h4>Client Name</h4>
                ...
                <div class="testimonial-item">
                    ...
                    <img class="rounded-circle mb-3" src="{{asset('img/testimonial-2.jpg')}}" alt="">
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
                <div class="testimonial-item">
                    ...
                    <img class="rounded-circle mb-3" src="{{asset('img/testimonial-3.jpg')}}" alt="">
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
                <div class="testimonial-item">
                    ...
                    <img class="rounded-circle mb-3" src="{{asset('img/testimonial-4.jpg')}}" alt="">
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
            </div>
