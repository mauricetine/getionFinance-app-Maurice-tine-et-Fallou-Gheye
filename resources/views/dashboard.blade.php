            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 bg-blue-100 text-blue-900">
                    <div class="flex justify-between">
                        <div>
                            <h3 class="text-2xl font-bold">Informations du compte :</h3>
                            <br>
                            <p class="mb-4">RIB : {{ $user->rib }}</p>
                            <p class="mb-4">Nom : {{ $user->name }}</p>
                            <p class="mb-4">Type de compte : {{ $user->type_compte }}</p>
                        </div>
                        <div class="self-end">
                            <h1 class="text-9xl font-bold">Solde : {{ $user->solde }}</h1>
                        </div>
                    </div>
                </div>
            </div>
